...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=techno.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: techno.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: techno.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: techno.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: techno.pcbook.Screen.resolution:type_name -> techno.pcbook.Screen.Resolution
	0, // 1: techno.pcbook.Screen.panel:type_name -> techno.pcbook.Screen.Panel
