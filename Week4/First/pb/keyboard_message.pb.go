...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=techno.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f, 0x2e, 0x70, 0x63,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: techno.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: techno.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: techno.pcbook.Keyboard.layout:type_name -> techno.pcbook.Keyboard.Layout
