...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=techno.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f, 0x2e,
	...
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x6e,
	0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	...
	0x15, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: techno.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: techno.pcbook.Storage
	(*Memory)(nil),      // 2: techno.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: techno.pcbook.Storage.driver:type_name -> techno.pcbook.Storage.Driver
	2, // 1: techno.pcbook.Storage.memory:type_name -> techno.pcbook.Memory
