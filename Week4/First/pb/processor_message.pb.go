...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x74, 0x65, 0x63, 0x68, 0x6e,
	0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: techno.pcbook.CPU
	(*GPU)(nil),    // 1: techno.pcbook.GPU
	(*Memory)(nil), // 2: techno.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: techno.pcbook.GPU.memory:type_name -> techno.pcbook.Memory
