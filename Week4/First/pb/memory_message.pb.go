...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=techno.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x6e, 0x6f, 0x2e, 0x70, 0x63,
	...
	0x0a, 0x07, 0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x42,
	...
	0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: techno.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: techno.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: techno.pcbook.Memory.unit:type_name -> techno.pcbook.Memory.Unit
