...
type MyMessage struct {
	...
	MyMap map[string]*Result `protobuf:"bytes,2,rep,name=myMap,proto3" json:"myMap,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *MyMessage) GetMyMap() map[string]*Result {
	if x != nil {
		return x.MyMap
	}
	return nil
...
var file_map_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6d, 0x61, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x09,
	0x4d, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2b, 0x0a, 0x05, 0x6d, 0x79, 0x4d,
	0x61, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x4d, 0x79, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x4d, 0x79, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x05, 0x6d, 0x79, 0x4d, 0x61, 0x70, 0x1a, 0x41, 0x0a, 0x0a, 0x4d, 0x79, 0x4d, 0x61, 0x70, 0x45,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x20, 0x0a, 0x06, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x03, 0x5a, 0x01, 0x2e,
...
var file_map_proto_goTypes = []interface{}{
	...
	(*Result)(nil),    // 1: Result
	nil,               // 2: MyMessage.MyMapEntry
}
var file_map_proto_depIdxs = []int32{
	2, // 0: MyMessage.myMap:type_name -> MyMessage.MyMapEntry
	1, // 1: MyMessage.MyMapEntry.value:type_name -> Result
